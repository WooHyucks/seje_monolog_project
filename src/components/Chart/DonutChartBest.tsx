...
const DonutBestChart = ({ idicatorsData }: idicatorsData) => {
  ...
  return (
    <div className='w-[277px] h-[120px] p-4 rounded-lg border border-gray-200 relative'>
      <div className="flex flex-col items-end justify-center gap-2">
        <div className="flex">
          <span className="text-sm font-bold text-scoreDataColor">Best</span>
          <div className="text-sm font-bold text-scoreDataColor ml-[52px]">
            <span className="">{totalSeconds.toFixed(1)}</span>
            <span className="text-sm">sec</span>
          </div>
        </div>
        <div className="flex justify-center items-center gap-2">
          <div className="w-3 h-3 bg-scoreDataColor"></div>
